    ...
    <div className="mx-4 mb-2 rounded-md border border-warning/40 bg-warning/10 px-3 py-2.5 shrink-0">
      {isMobile ? (
          ...
          <div className="flex items-start gap-2">
            ...
            <div className="min-w-0">
              ...
              <button
                ...
                className={`font-mono text-foreground-dim text-left mt-1 ${expanded ? "whitespace-pre-wrap break-all" : "truncate block w-full"}`}
              >
                {summary}
              </button>
            </div>
        ...
        <div className="flex flex-col gap-1.5 text-sm">
          ...
          <div className="font-mono text-xs text-foreground-dim pl-6 break-all">{summary}</div>
        </div>
      )}
    </div>
  );
