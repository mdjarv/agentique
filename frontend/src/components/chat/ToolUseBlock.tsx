    ...
    case "bash":
      return (
        <div className="border-t max-h-64 overflow-y-auto">
          ...
          {detail.output && (
            <pre className="px-2 pb-2 overflow-x-auto text-foreground-dim whitespace-pre-wrap text-[0.7rem] leading-relaxed border-t border-border/50">
              {detail.output}
            </pre>
          )}
        </div>
...
function ResultContentView({
  ...
  return (
    <div className="border-t">
      ...
      {textContent && (
        <pre className="p-2 overflow-x-auto text-foreground-dim whitespace-pre-wrap max-h-64 overflow-y-auto text-[0.7rem] leading-relaxed">
          {textContent}
        </pre>
      )}
    </div>
