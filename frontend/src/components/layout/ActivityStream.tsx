...
type AttentionKind = "approval" | "question" | "plan" | "failed" | "unseen" | "channel_msg";
...
// --- Hook: partition sessions + channels into sections ---

function useActivityStreamItems(
  searchQuery: string,
  ...
  // Raw store subscriptions — stable refs that only change when underlying data changes
