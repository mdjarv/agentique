...
export function BranchSelector({
  ...
  return (
    <div className="relative">
      ...
      {/* Inline dropdown */}
      {open && (
        <div className="absolute left-0 min-w-48 top-full z-50 mt-1 rounded-md border bg-popover text-popover-foreground shadow-md">
          {/* Filter input */}
          <div className="px-2 py-1.5 border-b">
            <input
              ...
              className="w-full bg-transparent text-xs outline-none placeholder:text-muted-foreground-faint"
            />
          </div>
