...
export function TemplateForm({ template, onDone, onCancel }: TemplateFormProps) {
  ...
  // The form renders inside the Templates settings panel, which already owns
  // the page header and the column width — so it contributes neither, only its
  // own way back out.
  return (
        ...
        <div className="grid grid-cols-2 max-md:grid-cols-1 gap-4">
          ...
          <div className="space-y-2">
            ...
            <select
              ...
              onChange={(e) =>
                updateSetting("effort", (e.target.value || undefined) as EffortLevel | undefined)
              }
              className="w-full h-9 rounded-md border bg-transparent px-3 text-sm focus:outline-none focus:ring-1 focus:ring-ring"
            >
              <option value="">Default</option>
          ...
          <div className="space-y-2">
            ...
            <select
              value={settings.worktree === undefined ? "" : settings.worktree ? "true" : "false"}
              onChange={(e) => {
          ...
          <div className="space-y-2">
            ...
            <select
              value={settings.planMode === undefined ? "" : settings.planMode ? "true" : "false"}
              onChange={(e) => {
                const v = e.target.value;
