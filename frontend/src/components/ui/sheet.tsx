...
function SheetContent({
  ...
  // A sheet is portaled outside the app shell, so it takes back the safe-area
  // insets on the edges it touches itself, or an installed PWA puts its first
  // and last rows under the status bar and the home indicator.
  return (
    <SheetPortal>
      <SheetOverlay />
