...
func (realProjectGitOps) HasUncommittedChanges(dir string) (bool, error) {
	return gitops.HasUncommittedChanges(dir)
}
func (realProjectGitOps) AutoCommitAll(dir, message string) error {
	return gitops.AutoCommitAll(dir, message)
}
func (realProjectGitOps) HeadCommitHash(dir string) (string, error) {
	return gitops.HeadCommitHash(dir)
}
func (realProjectGitOps) ListTrackedFiles(dir string) ([]string, error) {
	return gitops.ListTrackedFiles(dir)
}
func (realProjectGitOps) ListCommandFiles(dir string) ([]gitops.CommandFile, error) {
	return gitops.ListCommandFiles(dir)
}
func (realProjectGitOps) ListBranches(dir string) ([]string, []string, error) {
	return gitops.ListBranches(dir)
}
func (realProjectGitOps) CheckoutBranch(dir, branch string) error {
	return gitops.CheckoutBranch(dir, branch)
}
func (realProjectGitOps) UpstreamRef(dir string) (string, error) { return gitops.UpstreamRef(dir) }
func (realProjectGitOps) MergeBranch(dir, branch string) (string, error) {
	return gitops.MergeBranch(dir, branch)
}
func (realProjectGitOps) UncommittedFiles(dir string) ([]gitops.FileStatus, error) {
	return gitops.UncommittedFiles(dir)
}
func (realProjectGitOps) DiscardAll(dir string) error { return gitops.DiscardAll(dir) }
func (realProjectGitOps) ProjectStatus(dir string) gitops.ProjectStatusResult {
